...
const RenderDetailSection: React.FC<PostDetailData> = (postInfo: PostDetailData) => (
  <div>
      ...
      <p className='post-details-title-description'>{postInfo.location} | {postInfo.gradYear} Grad</p>
      <h3>Minimum qualifications:</h3>
      <p className='post-details-title-description'>{postInfo.minQualification}</p>
...
const AvatarAndButtons: React.FC<any> = () => (
  <div className="post-details-side">
      ...
      />
        ...
        <Button type='primary' className="post-details-side-button post-details-primary-button" style={{borderRadius: '10px',width: '140px'}}>Get Referred</Button>
        <br/>
        <Button className="post-details-side-button" style={{borderRadius: '10px',width: '140px'}}>View my Linkedin</Button>
  </div>
)
